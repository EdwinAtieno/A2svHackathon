...
class ChatSession(models.Model):
    ...
    def is_finance_related(self, query: str) -> bool:
        finance_keywords = [
            "finance", "investment", "savings", "returns", "risk", "stocks", "bonds", "mutual funds", "real estate",
            "retirement", "income", "budgeting", "financial freedom", "wealth", "credit", "debt", "insurance", "tax planning",
            "crypto", "401(k)", "IRA", "net worth", "stock market", "passive income", "robo-advisor", "financial planner",
            "investment strategy", "mortgage", "loan", "credit card", "money management", "financial literacy", "529 plan"
        ]
...
class ChatMessage(models.Model):
    ...
    def add_message(self, role: str, content: str) -> None:
        ...
        user_sessions = ChatSession.objects.filter(user=self.user).order_by('-created_at')
